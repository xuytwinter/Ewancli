...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("ewancli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("EWANCLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".ewancli", "runtime").toString();
        }
