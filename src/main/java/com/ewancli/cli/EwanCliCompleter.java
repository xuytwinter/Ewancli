...
import com.ewancli.mcp.mention.AtMentionCompleter;
...
final class EwanCliCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    EwanCliCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
