...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.ewancli.skill.SkillRegistry skillRegistry,
                               com.ewancli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "ewancli-multi-agent");
            t.setDaemon(true);
            return t;
        });
