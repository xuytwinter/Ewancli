...
final class LlmRetryPolicy {
    ...
    static final String MAX_ATTEMPTS_PROPERTY = "ewancli.llm.retry.max-attempts";
    static final String BASE_DELAY_MILLIS_PROPERTY = "ewancli.llm.retry.base-delay.millis";
    static final String MAX_DELAY_MILLIS_PROPERTY = "ewancli.llm.retry.max-delay.millis";
