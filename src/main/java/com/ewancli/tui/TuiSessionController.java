...
import com.ewancli.tui.history.ConversationSnapshot;
import com.ewancli.tui.pane.CenterPane;
import com.ewancli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final EwanCliConfig config;
    ...
    public TuiSessionController(EwanCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "ewancli-tui-agent-runner");
