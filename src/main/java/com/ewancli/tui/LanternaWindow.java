...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(EwanCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("Ewancli v16.0.0");
    ...
    public EwanCliConfig getConfig() {
        return config;
    }
}
