package com.ewancli.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[ewancli] stdout reader stopped: " + e.getMessage());
            }
        }, "ewancli-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[ewancli] stderr reader stopped: " + e.getMessage());
            }
        }, "ewancli-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
