...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/ewancli-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("ewancli.rag.dir", "/tmp/ewancli-test-rag-retriever");
