...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        EwanCliConfig config = new EwanCliConfig();
        config.getProviders().put("glm",
                new EwanCliConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new EwanCliConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void createsHunyuanClientFromHy4AliasAndConfiguredProvider() {
        ...
        config.getProviders().put("hunyuan",
                new EwanCliConfig.ProviderConfig(
                        "test-hunyuan-key",
    ...
    void returnsNullForUnknownProvider() {
        EwanCliConfig config = new EwanCliConfig();
        config.getProviders().put("unknown", new EwanCliConfig.ProviderConfig("test-key", null, "unknown-model"));
